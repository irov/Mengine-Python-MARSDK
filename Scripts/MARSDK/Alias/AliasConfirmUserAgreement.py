...
class AliasConfirmUserAgreement(TaskAlias):
    ...
    def _showUserAgreement(self):
        urls = {"url_left": unicode(MarParamsManager.getData("url_1"), "utf-8"), "url_right": unicode(MarParamsManager.getData("url_2"), "utf-8"), "url_center": unicode(MarParamsManager.getData("url_3"), "utf-8"), }
